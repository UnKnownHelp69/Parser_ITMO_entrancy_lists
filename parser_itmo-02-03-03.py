...
#data_selector = '.RatingPage_table__position__uYWvi'  #number and id
#data_selector = '.RatingPage_table__item__qMY0F'  #this is all users
#data_selector = '.RatingPage_table__FbzTn'  #all users_too ???
...
#data_selector = '.RatingPage_table__item__qMY0F'  #this is all users
#data_selector = '.RatingPage_table__FbzTn'  #all users_too but one text
...
if parsed_data_all:
    for item in parsed_data_all:
        ...
        if bool_bvi_kv:
            ...
            #print(f'Номер в списках: {user_num}, айди студента: {user_id}, приоритет направления: {priority}, баллы за ид : {id_sum}.')
